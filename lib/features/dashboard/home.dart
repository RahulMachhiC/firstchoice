      ...
      AppEnvironment.navigator.push(
        MaterialPageRoute(
          builder: (context) => BookingOTP(
            ...
            amount: context.read<AfterBookingController>().amount.toString(),
          ),
        ),
      );
    }
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      // ),
                      (model.dashboard?.previousDrivers.length ?? 0) > 0
                          ? sizedBoxWithHeight(10)
                          : SizedBox(),
                      (model.dashboard?.previousDrivers.length ?? 0) > 0
                          ? Text(
                  ...
                  sizedBoxWithHeight(10),
                  Container(
                    height: (model.dashboard?.previousDrivers.length ?? 0) > 0
                        ? 470.h
                        : 660.h,
                    child: ClipRRect(
