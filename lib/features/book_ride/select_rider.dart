...
class _SelectRiderState extends State<SelectRider> {
  ...
  _handleOnBackPressbutton() async {
            ...
            Navigator.of(context).pushAndRemoveUntil(
                MaterialPageRoute(
                  builder: (context) => PickupDropAddress(
                    pickupaddess: widget.pickupaddress,
                    lat: widget.pickuplatlong.latitude,
                    long: widget.pickuplatlong.longitude,
                  ),
                ),
                (_) => false);
          });
          ...
          child: SafeArea(
            child: Stack(
              children: [
                  ...
                  onMapCreated: (controller) {
                    controller.animateCamera(
                      CameraUpdate.newLatLngZoom(
                        ...
                        getZoomLevel(
                          LatLng(widget.pickuplatlong.latitude,
                              widget.pickuplatlong.longitude),
                ...
                InkWell(
                  onTap: () async {
                    await _handleOnBackPressbutton();
                  },
                  child: Container(
                    height: 40.h,
                    width: 40.w,
