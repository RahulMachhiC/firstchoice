...
import 'package:multitrip_user/features/scheduleride/scheduleridepickup.dart';
            ...
            InkWell(
              onTap: () {
                AppEnvironment.navigator.push(
                  MaterialPageRoute(
                    builder: (context) => ScheduleRidePickupDropAddress(
                      pickupaddess: widget.pickupaddess,
                      lat: widget.lat,
                      long: widget.long,
                      dropLocation: widget.dropLocation,
                      pickuptime:
                          "${selectedTime.hour.toString().padLeft(2, '0')}:${selectedTime.minute.toString().padLeft(2, '0')}:00",
                      pickupdate: DateFormat("dd-MM-yyyy").format(selectedDate),
                    ),
                  ),
                );
              },
